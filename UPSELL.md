...
- **Default URL:** `https://codemedicconsulting.netlify.app/jakarta-migration-audit`
...
- **Assumption:** The `https://codemedicconsulting.netlify.app/jakarta-migration-audit` landing page exists and is the default in `audit-upsell-config.properties`. Change it there; no code constant needs to be edited.
