...
| UI - Scan progress bar | `scan-progress-improvements.md` | Done | High-level phase updates, per-scan progress, throttling race, quick total, and physical transitive skip for quick scans implemented |
