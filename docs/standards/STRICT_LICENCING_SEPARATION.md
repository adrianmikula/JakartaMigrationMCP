...
lets also check that our dependency rule enforcement documented in docs\architecture\DEPENDENCY_BOUNDARIES.md successfully enforces the strict licensing requirements for our monetised open-core Apache-2 repo, without leaving any gaps for human or AI error which would 'leak' the apache-2 license to the premium code. 
