...
class MigrationImpactSummaryTest {
        ...
        private DependencyAnalysisReport createSampleDependencyReport() {
                ...
                List<VersionRecommendation> recommendations = List.of(
                                new VersionRecommendation(
                                                new Artifact("javax.servlet", "javax.servlet-api", "4.0.1", "compile",
                                                                false),
                                                new Artifact("jakarta.servlet", "jakarta.servlet-api", "6.0.0",
                                                                "compile", false),
                                                "Direct replacement",
                                                List.of(),
                                                1.0),
                ...
                return new DependencyAnalysisReport(graph, namespaceMap.namespaceMap(), blockers, recommendations, risk,
                                readiness);
        }
        ...
        private SourceCodeAnalysisResult createSampleSourceCodeResult() {
                FileUsage file1 = new FileUsage(
                                ...
                                List.of(
                                                new ImportStatement("javax.servlet.ServletException", "javax.servlet",
                                                                "jakarta.servlet.ServletException", 5),
                                                new ImportStatement("javax.servlet.http.HttpServlet", "javax.servlet",
                                                                "jakarta.servlet.http.HttpServlet", 6)),
                                50);

                FileUsage file2 = new FileUsage(
                                Paths.get("src/main/java/Validator.java"),
                                List.of(
                                                new ImportStatement("javax.validation.NotNull", "javax.validation",
                                                                "jakarta.validation.NotNull", 3)),
                                30);
        ...
        private DependencyAnalysisReport createSmallDependencyReport() {
                ...
                return new DependencyAnalysisReport(graph, new NamespaceCompatibilityMap().namespaceMap(), List.of(),
                                List.of(),
                                risk, readiness);
        }
        ...
        private DependencyAnalysisReport createMediumDependencyReport() {
                ...
                List<Blocker> blockers = List.of(
                                new Blocker(
                                                ...
                                                List.of(),
                                                0.8));
                return new DependencyAnalysisReport(graph, new NamespaceCompatibilityMap().namespaceMap(), blockers,
                                List.of(),
                                risk, readiness);
        }
        ...
        private SourceCodeAnalysisResult createMediumSourceCodeResult() {
                ...
                for (int i = 0; i < 60; i++) {
                        files.add(new FileUsage(
                                        ...
                                        List.of(new ImportStatement("javax.servlet.ServletException", "javax.servlet",
                                                        "jakarta.servlet.ServletException", 1)),
                                        50));
                }
        ...
        private DependencyAnalysisReport createLargeDependencyReport() {
                ...
                List<Blocker> blockers = List.of(
                                new Blocker(new Artifact("com.example", "lib1", "1.0", "compile", false),
                                                BlockerType.NO_JAKARTA_EQUIVALENT, "No equivalent", List.of(), 0.9),
                                new Blocker(new Artifact("com.example", "lib2", "1.0", "compile", false),
                                                BlockerType.NO_JAKARTA_EQUIVALENT, "No equivalent", List.of(), 0.9),
                                new Blocker(new Artifact("com.example", "lib3", "1.0", "compile", false),
                                                BlockerType.NO_JAKARTA_EQUIVALENT, "No equivalent", List.of(), 0.9),
                                new Blocker(new Artifact("com.example", "lib4", "1.0", "compile", false),
                                                BlockerType.NO_JAKARTA_EQUIVALENT, "No equivalent", List.of(), 0.9),
                                new Blocker(new Artifact("com.example", "lib5", "1.0", "compile", false),
                                                BlockerType.NO_JAKARTA_EQUIVALENT, "No equivalent", List.of(), 0.9),
                                new Blocker(new Artifact("com.example", "lib6", "1.0", "compile", false),
                                                BlockerType.NO_JAKARTA_EQUIVALENT, "No equivalent", List.of(), 0.9));
                return new DependencyAnalysisReport(graph, new NamespaceCompatibilityMap().namespaceMap(), blockers,
                                List.of(),
                                risk, readiness);
