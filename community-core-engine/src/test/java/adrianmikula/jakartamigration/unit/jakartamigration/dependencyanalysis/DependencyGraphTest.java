...
class DependencyGraphTest {
    ...
    void shouldColorCodeJakartaCompatibleDependencies() {
        // Given
        Artifact jakartaCompatible = new Artifact("jakarta.servlet", "jakarta.servlet-api", "6.0.0", "compile", false);
    ...
    private boolean hasJakartaVersion(Artifact artifact) {
        // This would be implemented to check if the artifact has a jakarta version
        // available
