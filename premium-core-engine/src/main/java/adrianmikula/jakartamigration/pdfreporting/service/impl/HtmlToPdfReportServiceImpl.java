...
public class HtmlToPdfReportServiceImpl implements PdfReportService {
    ...
    private String generateRefactoringActionHtml(RefactoringActionReportRequest request) {
        ...
        String commonStyles = cssCacheManager.getCachedCommonStyles() != null && !cssCacheManager.getCachedCommonStyles().isEmpty() ? cssCacheManager.getCachedCommonStyles() : getInlineCommonStyles();
        String headerStyles = getSharedHeaderStyles();
        String footerStyles = getSharedFooterStyles();
        String refactoringStyles = cssCacheManager.getCachedRefactoringStyles() != null && !cssCacheManager.getCachedRefactoringStyles().isEmpty() ? cssCacheManager.getCachedRefactoringStyles() : getInlineRefactoringStyles();
