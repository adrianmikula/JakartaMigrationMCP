...
/**
 * Unit tests for RiskGauge component angle calculations.
 * Tests needle rotation logic for different score ranges.
 */
public class RiskGaugeTest {
    ...
    private int getNeedleAngle() {
        return riskGauge.calculateNeedleAngle(riskGauge.getScore());
    }
}
