...
/**
 * Basic Refactor component - provides single-recipe refactoring functionality.
 * This is the original RefactorTabComponent logic extracted into a separate component.
 */
public class BasicRefactorComponent {
    private static final Logger LOG = Logger.getInstance(BasicRefactorComponent.class);
    ...
    public BasicRefactorComponent(@NotNull Project project, RecipeService recipeService) {
