...
public class RuntimeComponent {
    ...
    private void handleRemediate(ActionEvent e) {
        ...
        recommendations
                .append("   - Update namespace URIs in web.xml from http://xmlns.jcp.org to https://jakarta.ee\n");
    ...
    private void displayErrorAnalysis(ErrorAnalysis analysis) {
        ...
        if (analysis != null) {
            sb.append("Category: ").append(analysis.category() != null ? analysis.category().name() : "Unknown")
                    .append("\n");
    ...
    public JButton getRunHealthCheckButton() {
        return runHealthCheckButton;
    }

    public JButton getAnalyzeErrorsButton() {
        return analyzeErrorsButton;
    }

    public JButton getRemediateButton() {
        return remediateButton;
    }
}
